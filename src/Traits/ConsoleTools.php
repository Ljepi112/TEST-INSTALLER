...
trait ConsoleTools
{
    ...
    {
        $this->io->writeln("<bg=white;fg=yellow>[OPOZORILO] $msg</>\n");
    }
     ...
     */
    protected function throwError($error = 'Neznana napaka ...')
    {
    ...
    protected function question($question, $default = '')
    {
        do {
            ...
            if (!$valid) {
                $this->warning('Ni mogoče izprazniti ali vsebovati presledke!');
            }
