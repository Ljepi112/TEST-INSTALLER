...
use App\Installer\SLOshare\SLOshareSetup;
...
class InstallCommand extends Command
{
    ...
    private $steps = [
        ...
        SLOshareSetup::class => 'SLOshare Settings and Configuration',
    ];
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp('Provisions Server and installs the SLOshare Platform.');
    }
    ...
    private function info()
    {
        ...
        $this->io->writeln([
            '<fg=green>SLOshare has been successfully installed!</>',
            ' ',
